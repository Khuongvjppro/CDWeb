...
export default function OrdersPage() {
  const [orders, setOrders] = useState([
    { id: 1, customer: 'Nguyễn Văn A', amount: 450000, status: 'delivered', date: '2024-05-15' },
    { id: 2, customer: 'Trần Thị B', amount: 350000, status: 'shipped', date: '2024-05-14' },
    { id: 3, customer: 'Lê Văn C', amount: 250000, status: 'processing', date: '2024-05-13' },
    { id: 4, customer: 'Phạm Thị D', amount: 520000, status: 'pending', date: '2024-05-12' },
  ]);
